...
export function SignUp() {
  useEffect(() => { document.title = 'Create Account | Luxe Salon'; return () => { document.title = 'Luxe Salon — Premium Beauty & Wellness in Nairobi'; }; }, []);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join us and start your beauty journey</CardDescription>
        </CardHeader>
        <CardContent>
          {/* Google Sign-Up */}
          <Button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button id="email-signup-btn" type="submit" className="w-full" disabled={loading}>
