...
export function Login() {
  useEffect(() => { document.title = 'Sign In | Luxe Salon'; return () => { document.title = 'Luxe Salon — Premium Beauty & Wellness in Nairobi'; }; }, []);
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button id="email-signin-btn" type="submit" className="w-full" disabled={loading}>
